@extends('layouts.template.home.app_profile')
@section('title')
Profile
@endsection
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="btn btn-default">{{ Auth::user()->name}} Profile</h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                ...
                                <img class="profile-user-img img-fluid img-circle image-previewer" src="{{ asset('files/default.png')}}" alt="User profile picture">
                                @else
                                <img class="profile-user-img img-fluid img-circle image-previewer" src="{{ asset('files/'.Auth::user()->id.'/'.Auth::user()->picture)}}" alt="User profile picture">
                                @endif
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="exampleInputFile"><i class="fas fa-user"></i> Edit your image</label>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="email" class="form-control" id="inputName" name="name" value="{{Auth::user()->name}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="inputLastname" name="lastname" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="password" class="form-control" id="inputPwd" name="name" value="{{Auth::user()->password}}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" id="inputAdress" name="adress" value="Adress"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
