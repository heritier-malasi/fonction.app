@extends('layouts.template.home.apptemplate')
  ...
  <div class="container">
    ...
    <div class="row no-gutters">
      <div class="col-lg-6 video-box">
        <img src="{{ asset('mamba/assets/img/about.jpg')}}" class="img-fluid" alt="">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up">
        <div class="member">
          <div class="pic"><img src="{{ asset('mamba/assets/img/team/team-1.jpg')}}" class="img-fluid" alt=""></div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
        <div class="member">
          <div class="pic"><img src="{{ asset('mamba/assets/img/team/team-2.jpg')}}" class="img-fluid" alt=""></div>
          <div class="member-info">
            <h4>Sarah Jhonson</h4>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div class="member">
          <div class="pic"><img src="{{ asset('mamba/assets/img/team/team-3.jpg')}}" class="img-fluid" alt=""></div>
          <div class="member-info">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div class="member">
          <div class="pic"><img src="{{ asset('mamba/assets/img/team/team-4.jpg')}}" class="img-fluid" alt=""></div>
          <div class="member-info">
            <h4>Amanda Jepson</h4>
